package it.epicode.W2S5.Esercizio1_G2_S5;
...
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Bevanda;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Franchising;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Ordine;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Pizza;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Prodotto;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.StatoOrdine;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.StatoTavolo;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Tavolo;
import it.epicode.W2S5.Esercizio1_G2_S5.beans.Topping;
import it.epicode.W2S5.Esercizio1_G2_S5.decorator.AnanasDecorator;
import it.epicode.W2S5.Esercizio1_G2_S5.decorator.MozzarellaDecorator;
import it.epicode.W2S5.Esercizio1_G2_S5.decorator.PomodoroDecorator;
import it.epicode.W2S5.Esercizio1_G2_S5.decorator.ProsciuttoDecorator;
import it.epicode.W2S5.Esercizio1_G2_S5.decorator.SalameDecorator;

@SpringBootApplication
public class Esercizio1G2S5Application {
	
	static AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();

	public static void main(String[] args) {
		SpringApplication.run(Esercizio1G2S5Application.class, args);
	...
	public static void pizzeria() {
	    ...
	    ctx.scan("it.epicode.W2S5.Esercizio1_G2_S5.beans");
	    ctx.refresh();
